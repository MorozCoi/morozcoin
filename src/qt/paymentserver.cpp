...
const QString BITCOIN_IPC_PREFIX("morozcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click morozcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start morozcoin: click-to-pay handler");
    else
...
{
    // clicking on morozcoin: URLs creates FileOpen events on the Mac:
